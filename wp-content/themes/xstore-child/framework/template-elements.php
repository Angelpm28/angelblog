    ...
    function etheme_logo($fixed_header = false) {
    	...
    	?>
            <a href="<?php echo home_url(); ?>">
                <img src="<?php echo $logo['logo']['src']; ?>" alt="<?php bloginfo( 'description' ); ?>" <?php echo $logo['logo']['size'][3]; ?> class="logo-default" />
            	<img src="<?php echo $logo['fixed_logo']['src']; ?>" alt="<?php bloginfo( 'description' ); ?>" <?php echo $logo['fixed_logo']['size'][3]; ?> class="logo-fixed" />
            </a>
        <?php
            ...
            <?php if(count($gallery_filter['ids']) > 0): ?>
                <div class="post-gallery-slider slider_id-<?php echo $slider_id; ?>">
                    <?php foreach($gallery_filter['ids'] as $attach_id): ?>
                        <div>
                            <?php echo wp_get_attachment_image($attach_id, $args['size'] ); ?>
                        </div>
                    <?php endforeach; ?>
                </div>
