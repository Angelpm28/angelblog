...
<div class="post <?php if( is_sticky() )echo "sticky"; ?>">
    ...
    <blockquote class="entry-url"><a target="_blank" href="<?php echo get_post_meta( get_the_ID(), '_format_link_url', true ); ?>"><?php echo get_post_meta( get_the_ID(), '_format_link_url', true ); ?></a></blockquote>
