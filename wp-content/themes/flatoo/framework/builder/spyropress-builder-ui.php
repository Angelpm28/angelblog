...
<div id="builder" class="builder">
    <div id="builder-tabs">
        <h2 class="nav-tab-wrapper">
            <?php if ( $is_content ) { ?>
            <a href="#postdivrich" class="nav-tab<?php esc_attr_e(  $wordpress_class ); ?>">Wordpress</a>
            <?php } ?>
            <a href="#builder-data" class="nav-tab<?php esc_attr_e( $builder_class ); ?>">Builder</a>
        </h2>
    </div>
    <div id="builder-data">
        <div class="builder-header">
            <h2>ThemeSquared Builder</h2>
