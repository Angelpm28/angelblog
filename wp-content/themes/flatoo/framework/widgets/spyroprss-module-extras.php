<div class="builder-sections">
    <div class="toggle_set">
        ...
        <div class="toggle_container">
            <div class="row-fluid">
                <div class="<?php esc_attr_e( get_admin_column_class(2) ); ?>">
            ...
            <div class="section section-textarea section-full">
                <div class="controls">
                    <textarea class="field" id="<?php esc_attr_e( $widget->get_field_id( 'row_custom_css' ) );?>" name="<?php esc_attr_e( $widget->get_field_name( 'row_custom_css' ) );?>" rows="15"><?php esc_attr_e( $row_custom_css );?></textarea>
                </div>
