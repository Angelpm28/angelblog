...
?>
    <div id="<?php esc_attr_e( $id ); ?>" <?php print build_section_class( 'section-padder section-full', $item ); ?>>
        <?php build_heading( $item, $is_widget ); ?>
        <?php build_description( $item ); ?>
        <div class="controls row-fluid">
            <div class="span3 range-slider">
                <strong class="sub"><?php _e( 'Top:', 'spyropress' ); ?> <span><?php esc_html_e( $value['top'] ); ?></span></strong>
            ...
            <div class="span3 range-slider">
                <strong class="sub"><?php _e( 'Bottom:', 'spyropress' ); ?> <span><?php esc_html_e( $value['bottom'] ); ?></span></strong>
            ...
            <div class="span3 range-slider">
                <strong class="sub"><?php _e( 'Left:', 'spyropress' ); ?> <span><?php esc_html_e( $value['left'] ); ?></span></strong>
            ...
            <div class="span3 range-slider">
                <strong class="sub"><?php _e( 'Right:', 'spyropress' ); ?> <span><?php esc_html_e( $value['right'] ); ?></span></strong>
