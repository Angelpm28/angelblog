...
?>
    <div id="<?php esc_attr_e( $id ); ?>" <?php print build_section_class( 'section-typography section-full', $item ); ?>>
            ...
            <div class="row-fluid">
                <div class="span6">
                    <div class="pb10 web-font">
                        ...
                        <select name="<?php esc_attr_e( $item['name'] ); ?>[font-family]" class="chosen-typo" data-placeholder="<?php esc_attr_e( 'Select Font', 'spyropress' ); ?>" data-css="font-family">
                        <?php
                    ...
                    <div class="pb10 web-font row-fluid">
                        <div class="span6">
                            <select name="<?php esc_attr_e( $item['name'] ); ?>[font-style]" class="chosen-typo" data-placeholder="<?php esc_attr_e( 'Font Style', 'spyropress' ); ?>" data-css="font-style">
                            <?php
                        ...
                        <div class="span6">
                            <select name="<?php esc_attr_e( $item['name'] ); ?>[font-weight]" class="chosen-typo" data-placeholder="<?php esc_attr_e( 'Font Weight', 'spyropress' ); ?>" data-css="font-weight">
                            <?php
                    ...
                    <div class="pb10 google-font">
                        ...
                        <select id="<?php esc_attr_e( $id ); ?>-google" name="<?php esc_attr_e( $item['name'] ); ?>[font-google]" class="chosen-google-typo" data-placeholder="<?php esc_attr_e( 'Google Webfont', 'spyropress' ); ?>" data-selected="<?php esc_attr_e( $value['font-google'] ); ?>">
                        </select>
                    </div>
                    <div class="pb10 google-font">
                        <strong class="sub"><?php _e( 'Google Webfont Variants', 'spyropress' ); ?></strong>
                        <select id="<?php esc_attr_e( $id ); ?>-google-variant" name="<?php esc_attr_e( $item['name'] ); ?>[font-google-variant]" class="chosen-google-variant" data-placeholder="<?php esc_attr_e( 'Google Webfont Variants', 'spyropress' ); ?>" data-selected="<?php esc_attr_e( $value['font-google-variant'] ); ?>">
                        </select>
                    </div>
                </div>
                <div class="span6">
                    <div class="color-picker pb10 clearfix">
                        ...
                        <input type="text" class="field" name="<?php esc_attr_e( $item['name'] ); ?>[color]" id="<?php esc_attr_e( $id ); ?>-colorpicker" value="<?php esc_attr_e( $value['color'] ); ?>" />
                        <div class="color-box"><div<?php print $cp_style; ?>></div></div>
                    </div>
                    <div class="pb10 range-slider">
                        <strong class="sub"><?php _e( 'Font Size:', 'spyropress' ); ?> <span><?php esc_html_e( $value['font-size'] ); ?></span></strong>
                        <div data-css="font-size" id="<?php esc_attr_e( $id ); ?>-fontsize" class="slider"></div>
                        <input type="hidden" name="<?php esc_attr_e( $item['name'] ); ?>[font-size]" id="<?php esc_attr_e( $id ); ?>-fontsize-value" value="<?php esc_attr_e( $value['font-size'] ); ?>" />
                    </div>
                </div>
            </div>
            <div id="<?php esc_attr_e( $id ); ?>-preview" class="font-preview" style="<?php spyropress_font_preview($value); ?>">
        ...
        <div class="controls" style="display: none;">
            <div class="row-fluid">
                <div class="span3">
                    <select name="<?php esc_attr_e( $item['name'] ); ?>[font-decoration]" class="chosen-typo" data-placeholder="<?php esc_attr_e( 'Text Decoration', 'spyropress' ); ?>" data-css="text-decoration">
                    <?php
                ...
                <div class="span3">
                    <select name="<?php esc_attr_e( $item['name'] ); ?>[font-transform]" class="chosen-typo" data-placeholder="<?php esc_attr_e( 'Text Transform', 'spyropress' ); ?>" data-css="text-transform">
                    <?php
                ...
                <div class="span3 range-slider">
                    <strong class="sub"><?php _e( 'Line Height:', 'spyropress' ); ?> <span><?php esc_html_e( $value['line-height'] ); ?></span></strong>
                    <div data-css="line-height" id="<?php esc_attr_e( $id ); ?>-linehight" class="slider"></div>
                    <input type="hidden" name="<?php esc_attr_e( $item['name'] ); ?>[line-height]" id="<?php esc_attr_e( $id ); ?>-lineheight-value" value="<?php esc_attr_e( $value['line-height'] ); ?>" />
                </div>
                <div class="span3 range-slider">
                    <strong class="sub"><?php _e( 'Letter Spacing:', 'spyropress' ); ?> <span><?php esc_html_e( $value['letter-spacing'] ); ?></span></strong>
                    <div data-css="letter-spacing" id="<?php esc_attr_e( $id ); ?>-letterspacing" class="slider"></div>
                    <input type="hidden" name="<?php esc_attr_e( $item['name'] ); ?>[letter-spacing]" id="<?php esc_attr_e( $id ); ?>-letterspacing-value" value="<?php esc_attr_e( $value['letter-spacing'] ); ?>" />
                </div>
            </div>
            <br />
            ...
            <div class="row-fluid">
                <div class="span3 range-slider">
                    <strong class="sub"><?php _e( 'h-Shadow:', 'spyropress' ); ?> <span><?php esc_html_e( $value['text-hshadow'] ); ?></span></strong>
                    <div data-css="text-shadow" id="<?php esc_attr_e( $id ); ?>-hshadow" class="slider"></div>
                    <input type="hidden" name="<?php esc_attr_e( $item['name'] ); ?>[text-hshadow]" id="<?php esc_attr_e( $id ); ?>-hshadow-value" value="<?php esc_attr_e( $value['text-hshadow'] ); ?>" />
                </div>
                <div class="span3 range-slider">
                    <strong class="sub"><?php _e( 'v-Shadow:', 'spyropress' ); ?> <span><?php esc_html_e( $value['text-vshadow'] ); ?></span></strong>
                    <div data-css="text-shadow" id="<?php esc_attr_e( $id ); ?>-vshadow" class="slider"></div>
                    <input type="hidden" name="<?php esc_attr_e( $item['name'] ); ?>[text-vshadow]" id="<?php esc_attr_e( $id ); ?>-vshadow-value" value="<?php esc_attr_e( $value['text-vshadow'] ); ?>" />
                </div>
                <div class="span3 range-slider">
                    <strong class="sub"><?php _e( 'Blur:', 'spyropress' ); ?> <span><?php esc_html_e( $value['text-blur'] ); ?></span></strong>
                    <div data-css="text-shadow" id="<?php esc_attr_e( $id ); ?>-blur" class="slider"></div>
                    <input type="hidden" name="<?php esc_attr_e( $item['name'] ); ?>[text-blur]" id="<?php esc_attr_e( $id ); ?>-blur-value" value="<?php esc_attr_e( $value['text-blur'] ); ?>" />
                </div>
                <div class="span3 color-picker clearfix">
                    <input type="text" class="field shadow" name="<?php esc_attr_e( $item['name'] ); ?>[text-shadowcolor]" id="<?php esc_attr_e( $id ); ?>-shadowcolor" value="<?php esc_attr_e( $value['text-shadowcolor'] ); ?>" />
