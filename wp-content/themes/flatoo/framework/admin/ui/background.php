...
?>
    <div <?php echo build_section_class( 'section-background', $item ); ?>>
        ...
        <div class="controls">
            ...
            <div class="pb10">
                <select name="<?php esc_attr_e( $item['name'] ); ?>[background-position]" class="chosen" data-placeholder="<?php esc_attr_e( 'Background Position', 'spyropress' ); ?>">
                    <?php
            ...
            ?>
                <div class="screenshot" id="<?php esc_attr_e( $id ); ?>_image">
                <?php 
                      if ( $value['background-image'] != '' ) {
