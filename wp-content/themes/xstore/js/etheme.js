;(function($) {
    ...
    var etTheme = {
        ...
        photoSwipe: function() {
            ...
            setTimeout(function() {
                $('.zoom-images-button, .open-video-popup').addClass('showed');
            }, 400);
        ...
        fixedHeader: function() {
            ...
            var header = $('.header-wrapper'),
                ...
                menu = header.find('.menu-wrapper'),
                navbar = header.find('.navbar-header'),
                menuBtn = header.find('.navbar-toggle'),
                startOffset = 240;

            var fixedHeaderHtml = '<div class="fixed-header header-color-dark"><div class="container"><div class="header-logo">' + logo.html() + '</div><div class="menu-wrapper">' + menu.html() + '</div><div class="navbar-header">' + navbar.html() + '</div><div class="navbar-toggle">' + menuBtn.html() + '</div></div></div>';
        ...
        postLayout: function() {
            var postImage = $('.post-template-large .wp-picture img, .content-article .post-gallery-slider img').first(),
