...
<div class="actions">
	<input type="submit" class="btn gray big" name="update_cart" value="<?php esc_html_e( 'Update Cart', 'xstore' ); ?>" /> <input type="submit" class="checkout-button btn big alt wc-forward" name="proceed" value="<?php esc_html_e( 'Proceed to Checkout', 'xstore' ); ?>" />
