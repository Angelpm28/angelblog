...
if(!function_exists('etheme_top_cart')) {
	function etheme_top_cart($load_cart = false) {
		...
		?>
		<div class="shopping-container ico-design-<?php echo esc_attr( $icon_design ); ?>">
...
if(!function_exists('etheme_cart_number')) {
	function etheme_cart_number() {
		global $woocommerce;
		?>
			<span class="badge-number number-value-<?php echo $woocommerce->cart->cart_contents_count; ?>"><?php echo $woocommerce->cart->cart_contents_count; ?></span>
		<?php
	}
}
