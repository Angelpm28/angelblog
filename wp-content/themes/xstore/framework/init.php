...
//require_once( apply_filters('etheme_file_url', ET_CODE_3D . 'options-framework/ReduxCore/framework.php') );

/* load theme specific options */
if ( file_exists( apply_filters('etheme_file_url', ETHEME_THEME . 'theme-options.php') ) ) {
	require_once( apply_filters('etheme_file_url', ETHEME_THEME . 'theme-options.php') );
}
