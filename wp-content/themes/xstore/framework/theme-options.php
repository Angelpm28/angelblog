...
if(!function_exists('etheme_redux_init')) {
    function etheme_redux_init() {
        ...
        etheme_redux_header_types($opt_name);
        ...
        Redux::setSection( $opt_name, array(
            ...
            'fields' => array (
                ...
                array (
                    ...
                    'output' => array('.page-heading, .et-header-overlap .page-heading, .et-header-overlap .page-heading.bc-size-small'),
                    'units'          => array('em', 'px'),
                ...
                array (
                    ...
                    'output' => '.woocommerce-breadcrumb a, #breadcrumb a, .bbp-breadcrumb a, .woocommerce-breadcrumb .delimeter, #breadcrumb .delimeter, .bbp-breadcrumb .delimeter',
                    'text-align' => false,
                    'text-transform' => true,
                ),
                array (
        ...
        etheme_redux_theme_options($opt_name);
...
Surely you can find something for yourself!</p> ',
            ...
            Redux::setSection( $opt_name, array(
                ...
                'fields' => array (
                    ...
                    array (
                        ...
                        'default' => false,
                        'required' => array(
                            array('single_layout','equals', array('small', 'default', 'xsmall', 'large')),
                        )
                    ),
                    array (
        ...
        etheme_redux_theme_options_dummy($opt_name);
